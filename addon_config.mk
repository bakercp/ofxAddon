...
meta:
	ADDON_NAME = ofxAddon
	ADDON_DESCRIPTION = An openFrameworks addon template.
	ADDON_AUTHOR = bakercp
	ADDON_MAINTAINER = bakercp
	ADDON_URL = http://github.com/bakercp/ofxAddon
	ADDON_PLATFORMS = android emscripten ios linux linuxarmv6 linuxarmv7 msys2 osx tvos vs
	ADDON_DOCUMENTATION = http://bakercp.github.io/ofxAddon/
